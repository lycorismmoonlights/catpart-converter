...
CATPART_CADEX_LICENSE_FILE="/path/to/cadex_license.py" \
python3 plugins/catpart-converter/scripts/convert_catpart.py "<input.CATPart>" --backend cadexsdk --format step
```
